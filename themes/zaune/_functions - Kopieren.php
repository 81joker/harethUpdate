...
wp_enqueue_script('gallery-jquery', get_theme_file_uri('/js/gallery.js'), array('jquery', 'baguettebox'), '1.0', true);
    ...
    ///////////////////////////wp_enqueue_style('zaune-services', get_theme_file_uri('/css/services.css'));
    // wp_enqueue_style('zaune-templatemo-villa-agency', get_theme_file_uri('/css/properties/templatemo-villa-agency.css'));
    ///////////////////////////wp_enqueue_style('zaune-flex-slider', get_theme_file_uri('/css/properties/flex-slider.css'));
    // wp_enqueue_style('zaune-fontawesome', get_theme_file_uri('/css/properties/fontawesome.css'));
    ...
    wp_enqueue_script('breucke-lightbox.min', get_theme_file_uri('/js/lightbox.min.js'), array('jquery'), '1.0', true);
     ...
     wp_enqueue_script('breucke-custom', get_theme_file_uri('/js/properties/custom.js'), array('jquery'), '1.0', true);
